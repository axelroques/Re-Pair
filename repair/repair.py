...
class RePair:
    ...
    def process(self, s):
        ...
        phrase = self.initialize_data_structures(s)
        ...
        while True:
            ...
            pair, n_occurrence = self.most_reccuring_pair(phrase)
            ...
            self.replace_occurences(phrase, pair)
    ...
    def replace_occurences(phrase, pair):
        ...
        positions = RePair.prune_positions(np.array(phrase.positions[pair]))
    ...
    def get_results(self):
        ...
        return pd.DataFrame({
            'Rule': self.phrase.results['Rule'],
            'Expanded Rule': self.phrase.results['Expanded Rule'],
            'Occurrence': self.phrase.results['Occurrence'],
            'Phrase': self.phrase.results['Phrase']
        }, index=self.phrase.results['index'])
    ...
    def get_hierarchy(self):
        ...
        compute_hierarchy(self.phrase.results)
